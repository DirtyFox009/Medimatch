// Server-side copy of the triage system prompt (src/services/groq/prompts.ts).
// Kept separate so Vercel's function bundler never needs to resolve
// Metro/React-Native imports from src/. The underscore prefix stops Vercel
// from exposing this file as an endpoint. Keep the two files in sync.
